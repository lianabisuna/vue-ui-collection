...
const breadcrumbItems1: BreadcrumbProp[] = [
  { active: false, title: 'Home', to: '/' },
  { active: false, title: 'Products', to: '/' },
  { active: false, title: 'Appliances', to: '/' },
  { active: true, title: 'Refrigerators', to: '/' },
]
